...
clean-Example-2f-User:
	-$(RM) ./Example/User/GPIO.d ./Example/User/GPIO.o ./Example/User/MFRC522.d ./Example/User/MFRC522.o ./Example/User/RFID-tag.d ./Example/User/RFID-tag.o ./Example/User/SPI.d ./Example/User/SPI.o ./Example/User/UART.d ./Example/User/UART.o ./Example/User/lcd.d ./Example/User/lcd.o ./Example/User/log.d ./Example/User/log.o ./Example/User/main.d ./Example/User/main.o ./Example/User/mems.d ./Example/User/mems.o ./Example/User/retarget.d ./Example/User/retarget.o ./Example/User/stm32f4xx_hal_msp_spi.d ./Example/User/stm32f4xx_hal_msp_spi.o ./Example/User/stm32f4xx_hal_msp_uart.d ./Example/User/stm32f4xx_hal_msp_uart.o ./Example/User/stm32f4xx_it.d ./Example/User/stm32f4xx_it.o ./Example/User/touchscreen.d ./Example/User/touchscreen.o ./Example/User/ts_calibration.d ./Example/User/ts_calibration.o
